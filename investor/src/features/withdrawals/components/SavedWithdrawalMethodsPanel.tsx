...
import { apiErrorMessage } from '@/shared/lib/utils';
import {
  accountNumberError,
  bankNameError,
  ifscError,
...
export function SavedWithdrawalMethodsPanel({
  ...
  const saveMethod = useMutation({
    ...
    onError: (err) => setFormError(apiErrorMessage(err, 'Could not save method')),
  });
  ...
  const setDefaultMethod = useMutation({
    ...
    onError: (err) => setListError(apiErrorMessage(err, 'Default update failed')),
  });
  ...
  const deleteMethod = useMutation({
    ...
    onError: (err) => setListError(apiErrorMessage(err, 'Delete failed')),
  });
