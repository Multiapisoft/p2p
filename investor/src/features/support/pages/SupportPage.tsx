  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="font-[family-name:var(--font-headline)] text-2xl font-bold">Support</h1>
          <p className="text-on-surface-variant">
            Your tickets and payment disputes on your investments
          </p>
        </div>
      ...
      >
        {loadingTicket ? (
          ...
          <div className="space-y-4">
            ...
            >
              <Textarea label="Reply" value={reply} onChange={(e) => setReply(e.target.value)} required />
